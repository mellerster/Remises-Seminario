...
class Pasajero {
	...
	static hasMany = [solicitudesAcompaniamiento: SolicitudAcompaniamiento, solicitudesAmistad: SolicitudAmistad, amigos: Pasajero, reservas: Reserva, destinosFrecuentes: Parada,calificaciones: Calificacion]
