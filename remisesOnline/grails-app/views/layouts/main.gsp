...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<link rel="shortcut icon" href="${resource(dir: 'images', file: 'remises-new-favicon.ico')}" type="image/x-icon">
		<link rel="remises-new-touch-icon" href="${resource(dir: 'images', file: 'remises-new-touch-icon.png')}">
