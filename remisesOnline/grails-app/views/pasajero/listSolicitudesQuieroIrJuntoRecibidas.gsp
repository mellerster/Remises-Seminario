	...
	<body>
		...
		<div class="nav" role="navigation">
			...
			<thead>
				...
				<tbody>
				<g:each in="${solicitudesRecibidas}" status="i" var="solicitudQuieroIrJuntoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="aprobarSolicitud" controller="solicitudQuieroIrJunto" id="${solicitudQuieroIrJuntoInstance.id}"><input type="button" value="Aceptar" /></g:link>
						     <g:link action="denegarSolicitud" controller="solicitudQuieroIrJunto" id="${solicitudQuieroIrJuntoInstance.id}"><input type="button" value="Denegar" /></g:link>
						</td>
